...
export const addCharToInput = (state, char) => {
...
export const performOperation = (state) => {
...
export const deleteLastChar = (state) => {
...
export const setOperation = (state, op) => {
...
export const handleSqrt = (state) => {
    ...
    if (num < 0)
        throw new Error('квадратный корень из отрицательного числа не определен');
